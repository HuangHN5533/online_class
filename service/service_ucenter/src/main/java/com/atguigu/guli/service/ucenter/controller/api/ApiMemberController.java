...
public class ApiMemberController {
    ...
    public R register(@ApiParam(value = "会员信息", required = true) @RequestBody RegisterVo registerVo){
    ...
    @ApiOperation("会员登录")
    @PostMapping("login")
    public R login(@ApiParam(value = "用户", required = true) @RequestBody LoginVo loginVo){
    ...
    @GetMapping("inner/get-member-dto/{member}")
    public MemberDto getMemberDto(@ApiParam(value = "会员id", required = true) @PathVariable("member") String memberId){
