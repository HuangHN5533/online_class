...
import com.atguigu.guli.service.ucenter.utils.UcenterWxProperties;
...
public class ApiWxController {
    ...
    @Autowired
    private UcenterWxProperties ucenterWxProperties;
    ...
    public String genQrConnect(HttpSession session){
        ...
        String redirectUri = "";
        try {
            redirectUri = URLEncoder.encode(ucenterWxProperties.getRedirectUri(), "UTF-8");
    ...
    public String callback(String code, String state, HttpSession session){
        ...
        accessTokenParam.put("appid", ucenterWxProperties.getAppId());
        accessTokenParam.put("secret", ucenterWxProperties.getAppSecret());
